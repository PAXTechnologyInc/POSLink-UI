/*
 * Copyright (C) 2017 - ? Pax Corporation.
 *
...
public class ExpandItemAnimator extends SimpleItemAnimator {
    ...
    public ExpandItemAnimator() {
        this(R.id.expandable);
    }

    public ExpandItemAnimator(@IdRes int expandViewId) {
        ...
        if (view != null) {
            ...
            oldViewAnim.alpha(0).setListener(new VpaListenerAdapter() {
                ...
                public void onAnimationStart(View view) {
                    ...
                    if (changeInfo.oldHolder instanceof BaseExpandableViewHolder && changeInfo.newHolder instanceof BaseExpandableViewHolder) {
                        expandAnimation(changeInfo.oldHolder.itemView.findViewById(expandViewId));
                        if (changeInfo.oldHolder.getAdapterPosition() != changeInfo.newHolder.getAdapterPosition()) {
                            expandAnimation(changeInfo.newHolder.itemView.findViewById(expandViewId));
                        }
                    }
                }
                ...
                private void expandAnimation(View expandedView) {
                    if (expandedView == null)
                        return;
                    if (expandedView.getVisibility() == View.GONE) {
                        Animation expandAnim = expandAnimation == null ? new TranslateAnimation(0, 0, 0, 1) : expandAnimation;
                        expandAnim.setDuration(getChangeDuration());
                        expandedView.startAnimation(expandAnim);
                    } else {
                        Animation collapseAnim = expandAnimation == null ? new TranslateAnimation(0, 0, 1, 0) : collapseAnimation;
                        collapseAnim.setDuration(getChangeDuration());
                        expandedView.startAnimation(collapseAnim);
    ...
    public void setExpandAnimation(Animation expandAnimation) {
    ...
    public void setCollapseAnimation(Animation collapseAnimation) {
