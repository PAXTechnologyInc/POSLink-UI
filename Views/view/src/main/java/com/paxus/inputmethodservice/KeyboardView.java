...
package com.paxus.inputmethodservice;
...
import com.paxus.inputmethodservice.Keyboard.Key;
...
/**
 * Created by Kim.L 2021/8/16
 * Copy from {@link android.inputmethodservice.KeyboardView}
 */
...
public class KeyboardView extends View implements View.OnClickListener {
    ...
    private static final int[] LONG_PRESSABLE_STATE_SET = {
            Resources.getSystem().getIdentifier("state_long_pressable", "attr", "android")
    };
    ...
    public KeyboardView(Context context, AttributeSet attrs) {
        this(context, attrs,
                Resources.getSystem().getIdentifier("keyboardViewStyle", "attr", "android"));
    }
    ...
    public KeyboardView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.MockKeyboardView, defStyleAttr, defStyleRes);
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (attr == R.styleable.MockKeyboardView_android_keyBackground)
                mKeyBackground = a.getDrawable(attr);
            else if (attr == R.styleable.MockKeyboardView_android_verticalCorrection)
                mVerticalCorrection = a.getDimensionPixelOffset(attr, 0);
            else if (attr == R.styleable.MockKeyboardView_android_keyPreviewLayout)
                previewLayout = a.getResourceId(attr, 0);
            else if (attr == R.styleable.MockKeyboardView_android_keyPreviewOffset)
                mPreviewOffset = a.getDimensionPixelOffset(attr, 0);
            else if (attr == R.styleable.MockKeyboardView_android_keyPreviewHeight)
                mPreviewHeight = a.getDimensionPixelSize(attr, 80);
            else if (attr == R.styleable.MockKeyboardView_android_keyTextSize)
                mKeyTextSize = a.getDimensionPixelSize(attr, 18);
            else if (attr == R.styleable.MockKeyboardView_android_keyTextColor)
                mKeyTextColor = a.getColor(attr, 0xFF000000);
            else if (attr == R.styleable.MockKeyboardView_android_labelTextSize)
                mLabelTextSize = a.getDimensionPixelSize(attr, 14);
            else if (attr == R.styleable.MockKeyboardView_android_popupLayout)
                mPopupLayout = a.getResourceId(attr, 0);
            else if (attr == R.styleable.MockKeyboardView_android_shadowColor)
                mShadowColor = a.getColor(attr, 0);
            else if (attr == R.styleable.MockKeyboardView_android_shadowRadius)
                mShadowRadius = a.getFloat(attr, 0f);
        }

        a.recycle();

        a = getContext().obtainStyledAttributes(R.styleable.MockTheme);
        mBackgroundDimAmount = a.getFloat(R.styleable.MockTheme_android_backgroundDimAmount, 0.5f);
        a.recycle();
        ...
        mDisambiguateSwipe = getResources().getBoolean(
                getInternalResId("config_swipeDisambiguation", "bool"));
        ...
        if (mAccessibilityManager.isEnabled()) {
            ...
            switch (code) {
                case Keyboard.KEYCODE_ALT:
                    text = mContext.getString(getInternalResId("keyboardview_keycode_alt", "string"));
                    break;
                case Keyboard.KEYCODE_CANCEL:
                    text = mContext.getString(getInternalResId("keyboardview_keycode_cancel", "string"));
                    break;
                case Keyboard.KEYCODE_DELETE:
                    text = mContext.getString(getInternalResId("keyboardview_keycode_delete", "string"));
                    break;
                case Keyboard.KEYCODE_DONE:
                    text = mContext.getString(getInternalResId("keyboardview_keycode_done", "string"));
                    break;
                case Keyboard.KEYCODE_MODE_CHANGE:
                    text = mContext.getString(getInternalResId("keyboardview_keycode_mode_change", "string"));
                    break;
                case Keyboard.KEYCODE_SHIFT:
                    text = mContext.getString(getInternalResId("keyboardview_keycode_shift", "string"));
                    break;
                case '\n':
                    text = mContext.getString(getInternalResId("keyboardview_keycode_enter", "string"));
                    break;
                default:
        ...
        if (popupKeyboardId != 0) {
            ...
            if (mMiniKeyboardContainer == null) {
                ...
                mMiniKeyboard = (KeyboardView) mMiniKeyboardContainer.findViewById(
                        getInternalResId("keyboardView", "id"));
                View closeButton = mMiniKeyboardContainer.findViewById(
                        getInternalResId("closeButton", "id"));
    ...
    private int getInternalResId(String name, String type) {
