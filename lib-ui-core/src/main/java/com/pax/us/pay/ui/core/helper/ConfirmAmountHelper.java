...
public class ConfirmAmountHelper extends BaseActionHelper {
    public ConfirmAmountHelper(@Nullable IComirmAmountsListener uiListener, @Nullable IRespStatus respStatus) {
    ...
    public interface IComirmAmountsListener extends IMessageListener, ICurrencyListener, IAmountListener, IOptionListener {
    }
