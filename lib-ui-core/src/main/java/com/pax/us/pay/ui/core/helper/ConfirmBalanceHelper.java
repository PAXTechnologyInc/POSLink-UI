...
public class ConfirmBalanceHelper extends BaseActionHelper {
    public ConfirmBalanceHelper(@Nullable IConFirmBalanceListener uiListener, @Nullable IRespStatus respStatus) {
    ...
    public interface IConFirmBalanceListener extends IMessageListener, ICurrencyListener, IAmountListener {
    }
