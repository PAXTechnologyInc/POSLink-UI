...
public class ConfirmTotalAmountHelper extends BaseActionHelper {
    public ConfirmTotalAmountHelper(@Nullable IConFirmTotalAmountListener uiListener, @Nullable IRespStatus respStatus) {
    ...
    public interface IConFirmTotalAmountListener extends IMessageListener, ICurrencyListener, IAmountListener {
    }
