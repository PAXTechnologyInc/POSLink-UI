...
public class UIDataHandler {
    ...
    static {
        ...
        EXTRA_DATA_MAP.put("tip1", AMOUNT);//ANBP1039, When send Tip/Cashback from poslink, terminal should show the tip/cashback amount in receipt side
        EXTRA_DATA_MAP.put("tip2", AMOUNT);//ANBP1039, When send Tip/Cashback from poslink, terminal should show the tip/cashback amount in receipt side
        EXTRA_DATA_MAP.put("tip3", AMOUNT);//ANBP1039, When send Tip/Cashback from poslink, terminal should show the tip/cashback amount in receipt side
