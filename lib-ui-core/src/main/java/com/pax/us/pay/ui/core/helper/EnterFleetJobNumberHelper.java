...
public class EnterFleetJobNumberHelper extends BaseActionHelper {

    public EnterFleetJobNumberHelper(@Nullable IEnterFleetJobNumberListener uiListener, @Nullable IRespStatus respStatus) {
        super(uiListener, respStatus);
    }

    public void sendNext(String jobNumber) {
        Bundle bundle = new Bundle();
        bundle.putString(EntryRequest.PARAM_FLEET_JOB_NUMBER, jobNumber);
    ...
    public interface IEnterFleetJobNumberListener extends IMessageListener, ICurrencyListener, IAmountListener {
    }
