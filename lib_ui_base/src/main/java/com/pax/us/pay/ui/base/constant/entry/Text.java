...
public class Text {
     ...
     */
    public static final String ACTION_ENTER_TRANS_NO = "com.pax.us.pay.action.ENTER_TRANS_NO";
     ...
     */
    public static final String ACTION_ENTER_REFERENCE_NUMBER = "com.pax.us.pay.action.ENTER_REFERENCE_NO";


    /**
     * The intent action of Enter invoice number
     */
    public static final String ACTION_ENTER_INVOICE_NUMBER = "com.pax.us.pay.action.ENTER_INVOICE_NO";
     ...
     */
    public static final String ACTION_ENTER_CAHSBACK = "com.pax.us.pay.action.ENTER_CASH_BACK";
