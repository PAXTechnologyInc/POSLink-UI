...
//    }
    ...
    static {
        ...
        TRANS_MAP.put(EntryExtraData.PARAM_TRANS_NUMBER, "Trans Number : ");
        TRANS_MAP.put(EntryExtraData.PARAM_CARD_NUMBER, "Card Number : ");
        TRANS_MAP.put(EntryExtraData.PARAM_BATCH_NUMBER, "Catch Number : ");
        TRANS_MAP.put(EntryExtraData.PARAM_ORDER_NUMBER, "Order Number : ");
