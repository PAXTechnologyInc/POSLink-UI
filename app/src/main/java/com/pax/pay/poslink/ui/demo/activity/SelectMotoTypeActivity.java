...
public class SelectMotoTypeActivity extends AppCompatActivity implements View.OnClickListener, SelectOptionsHelper.ISelectOptionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvPrompt.setText("Please Select MOTO Type");
        ...
        if (options != null) {
            ...
            mAdapter = new RecyclerView.Adapter<BaseViewHolder<String>>() {
                ...
                public BaseViewHolder<String> onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                    return new OptionModelViewHolder(LayoutInflater.from(SelectMotoTypeActivity.this).inflate(R.layout.item_mode_grid, parent, false));
                }
