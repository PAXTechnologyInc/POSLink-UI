...
public class DisplayFeeActivity extends AppCompatActivity implements View.OnClickListener, ConfirmHelper.IConfirmListener {
    ...
    public void onShowInformation(Map<String, String> informations) {
        ...
        for (Map.Entry<String, String> value : DisplayInfoContent.FEE_MAP.entrySet()) {
