...
public class SelectTaxReasonActivity extends AppCompatActivity implements View.OnClickListener, SelectOptionsHelper.ISelectOptionListener {
        ...
        if (options != null) {
            ...
            mAdapter = new RecyclerView.Adapter<BaseViewHolder<String>>() {
                ...
                public BaseViewHolder<String> onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                    return new OptionModelViewHolder(LayoutInflater.from(SelectTaxReasonActivity.this).inflate(R.layout.item_mode_grid, parent, false));
                }
