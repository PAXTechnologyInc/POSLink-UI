...
import com.pax.us.pay.ui.core.helper.EnterPhoneNumHelper;
import com.paxus.utils.StringUtils;

public class EnterPhoneNumberActivity extends EnterDataLine1Activity<String> implements EnterPhoneNumHelper.IEnterPhoneNumListener {
    private EnterPhoneNumHelper helper;
    private int min;
    private int max;
    ...
    protected void loadOtherParam(String label) {
        ...
        if (!TextUtils.isEmpty(lengthRange)) {
            limit = new EditTextDataLimit(getResources().getString(R.string.pls_input_phone_number),
            ...
            limit = new EditTextDataLimit(getString(R.string.pls_input_phone_number),
