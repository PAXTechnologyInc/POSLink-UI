...
import com.pax.us.pay.ui.base.message.helper.AuthCodeHelper;
...
public class EnterAuthCodeActivity extends AppCompatActivity implements View.OnClickListener, IMessageListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        promptTv.setText(getResources().getText(R.string.please_enter_auth_code));
        minLen = 0;
        maxLen = 300;
        ...
        displayRespStatus.setListener(new DisplayRespStatus.DisplayRespStatusListener() {
            ...
            public void unRegister() {
                UIMessageManager.getInstance().unregisterUI(EnterAuthCodeActivity.this, helper);
            }
        });
