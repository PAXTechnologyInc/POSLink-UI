...
abstract class SelectLineActivity extends BaseAppActivity implements SelectOptionsHelper.ISelectOptionListener {
    ...
    protected int getLayoutId() {
        return R.layout.activity_select_ebt_type_default;
    }
