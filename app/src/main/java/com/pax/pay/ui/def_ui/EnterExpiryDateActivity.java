...
import com.pax.us.pay.ui.base.message.helper.ExpiryDateHelper;
...
public class EnterExpiryDateActivity extends AppCompatActivity implements View.OnClickListener, IMessageListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        promptTv.setText(getResources().getText(R.string.pls_input_expiry_date));
        minLen = 0;
        maxLen = 300;
        ...
        displayRespStatus.setListener(new DisplayRespStatus.DisplayRespStatusListener() {
            ...
            public void unRegister() {
                UIMessageManager.getInstance().unregisterUI(EnterExpiryDateActivity.this, helper);
            }
        });
    ...
    public void onResume() {
        ...
        EnterDataLineHelper.setEditTextExpiry(this, mEditText, maxLen, 0);
    }
